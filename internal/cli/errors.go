...
// or OTPRejected (a channel OTP create-channel or update-channel sent to
...
func classify(err error) errorEnvelope {
	...
	// monitor.ErrOTPRejected, like dns.ErrZoneBusy, dns.ErrFailed, and
	// dns.ErrNotSettled below, is always wrapped alone (never alongside an
	// *APIError): CreateChannel and UpdateChannel return it directly, after
