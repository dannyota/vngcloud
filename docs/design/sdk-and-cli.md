...
| `v0.17.0` | `globalloadbalancer` CLI commands; see [CLI reads](cli-reads.md) |
| `v0.18.0` | `containerregistry list-repositories` and wider map key redaction; see [CLI reads](cli-reads.md) |
